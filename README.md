...
- When enabling CloudFlare for your domain, they use an MX entry that exposes your web hosting server IP. Ideally we want that protected. To help solve this I'm using Proton.
- [Try Proton - Encryption email for personal and business uses](https://pr.tn/ref/X8QHC3Q9JH10) 
- This is an affiliate link - we both get discounts, you protect yourself, its a win-win-win.
...
- [DNS Checker](https://dnschecker.org/#TXT/)
- [Hardenize.com Help secure your website](https://www.hardenize.com)
...
- [Ninja Lapa](https://www.lapa.ninja/#google_vignette)
...
- [Cubic Bezier Animations](https://cubic-bezier.com/#.17,.67,.83,.67)
...
- [AI-generated Avatars](https://uifaces.co/)

### Browser Compatibility / Optimize Website
- [Can I Use](https://caniuse.com/?search=text-align)
...
### Icons (free for commercial use)
- [SVG Repo (public domain icons)](https://www.svgrepo.com/)
- [Google Icons (Apache License, v2.0)](https://fonts.google.com/icons)
- [Font Awesome (CC by 4.0 license; Must give credit)](https://fontawesome.com/)
- [Icons8 (Must give credit in your software/website)](https://icons8.com/)
- [SF Symbols by Apple (Only allowed to use for Apple device apps. Correct me if I’m wrong)](https://developer.apple.com/sf-symbols/)

### Icons (free for personal projects; premium options for commercial uses)
...
- [Blend](https://colinkeany.com/blend/)
...
### Lorem ipsom text and dummy user text
- [Random User Generator](https://randomuser.me/) 
- [Lorem Ipsum Generator](https://loremipsum.io)

### Screenshot Mockups
- [Screenshot.Rocks](https://screenshot.rocks)
- [Skymakers MockUPhone](https://mockuphone.com)
...
### The world is your oyster, go make something happen!
